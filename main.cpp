...
int _tmain(int argc, TCHAR* argv[], TCHAR* envp[])
{
	...
	BSTR inName = L"D:\\makefile\\CL\\CUDA\\DEM_2980_3515.img";			//It is the directory of the input DEM image
	BSTR outName = L"D:\\makefile\\CL\\CUDA\\DEM_2980_3515_CP_22.0.img";	//It is the directory of the output cirtical point
	ofstream timeTxt;
	timeTxt.open("D:\\DEM_2980_3515_CP_22.0.txt");		//The text is recording the computation time
	begin = clock();
	GDALPointSelect(inName, 22.0, outName);			//22.0 is the threshold value
	end = clock();

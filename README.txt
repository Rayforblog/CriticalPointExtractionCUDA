...
2)Download all of the files except the ReadMe.txt from the website (https://github.com/parallelProject/CriticalPointExtraction)
  (Tip: the gdal.lib in the "lib" folder of the "include" folder is larger than 50M, it is maybe wrong in the downloaded
  CriticalPointExtraction-master.Zip. If it is wrong, download in seperate and replace the library file in the "lib" folder.)

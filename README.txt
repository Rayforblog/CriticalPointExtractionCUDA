...
Visual Studio and CUDA8.0 are installed on a computer with the NVIDIA graphics card which the compute capability is 2.1 or above (The Visual Studio 2013 is used here)
